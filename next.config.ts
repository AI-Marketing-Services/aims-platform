...
const securityHeaders = [
  ...
  // Content-Security-Policy — allow Clerk, Stripe, AI SDK, and our CDN assets
  {
    ...
    value: [
      ...
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://clerk.aioperatorcollective.com https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com https://js.stripe.com https://accounts.google.com https://client.crisp.chat https://assets.calendly.com",
      // Styles: self + unsafe-inline (required by Tailwind / shadcn)
      "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://client.crisp.chat https://assets.calendly.com",
      // Fonts
      "font-src 'self' https://fonts.gstatic.com https://client.crisp.chat https://assets.calendly.com",
      // Images: self + Clerk CDN + Clearbit logos + data URIs
      "img-src 'self' data: blob: https://clerk.aioperatorcollective.com https://img.clerk.com https://images.clerk.dev https://logo.clearbit.com https://www.google.com https://lh3.googleusercontent.com https://image.crisp.chat https://client.crisp.chat https://storage.crisp.chat https://assets.calendly.com",
      // Connect: API calls to AI services, Stripe, Clerk
      "connect-src 'self' https://clerk.aioperatorcollective.com https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com https://api.stripe.com https://generativelanguage.googleapis.com https://api.anthropic.com https://api.tavily.com https://api.mn.co https://upstash.io https://*.upstash.io wss://ws.clerk.com wss://clerk.aioperatorcollective.com https://client.crisp.chat https://storage.crisp.chat wss://client.relay.crisp.chat wss://stream.relay.crisp.chat https://calendly.com https://*.calendly.com",
      // Frames: Stripe + Calendly embedded UI
      "frame-src 'self' https://challenges.cloudflare.com https://js.stripe.com https://hooks.stripe.com https://game.crisp.chat https://player.vimeo.com https://calendly.com https://*.calendly.com",
      // Workers
