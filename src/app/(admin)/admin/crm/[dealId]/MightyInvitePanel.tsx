    ...
    <div className="bg-card border border-border rounded-xl p-5">
      ...
      {mightyMemberId && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center gap-1.5 mb-3 text-xs font-semibold text-[#C4972A] hover:underline"
        >
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 bg-[#C4972A] text-white text-xs font-medium rounded-lg hover:bg-[#A17D22] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
