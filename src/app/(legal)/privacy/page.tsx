...
export default function PrivacyPage() {
  ...
  return (
    <section>
      ...
      <p className="text-xs text-[#737373] mb-4">a division of Modern-Amenities, LLC</p>
      <h1 className="text-3xl sm:text-4xl font-bold text-[#1A1A1A] mb-2">Privacy Policy</h1>
      ...
      <div className="mb-10 rounded-md border border-crimson/30 bg-crimson/5 p-4">
        <p className="text-sm text-[#737373] leading-relaxed">
          This Privacy Policy describes how <strong className="text-[#1A1A1A]">Modern-Amenities, LLC</strong>,
          doing business as <strong className="text-[#1A1A1A]">AI Operators Collective</strong>
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-[#737373] [&_h2]:text-[#1A1A1A] [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-4 [&_strong]:text-[#1A1A1A] [&_h3]:text-[#1A1A1A] [&_h3]:text-base [&_h3]:font-semibold [&_h3]:mt-6 [&_h3]:mb-2">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li><strong>Opt out:</strong> unsubscribe from marketing emails via the unsubscribe link (or at{" "}
            <Link href="/unsubscribe" className="text-crimson hover:underline">
              /unsubscribe
            </Link>
