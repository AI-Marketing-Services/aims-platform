...
export default function TermsPage() {
  ...
  return (
    <section>
      <p className="text-xs font-mono uppercase tracking-wider text-[#737373] mb-2">
        AI Operators Collective
      </p>
      <p className="text-xs text-[#737373] mb-4">
        a division of Modern-Amenities, LLC
      </p>
      <h1 className="text-3xl sm:text-4xl font-bold text-[#1A1A1A] mb-2">Terms of Service</h1>
      <p className="text-sm text-[#737373] mb-8">Last updated: {lastUpdated}</p>

      <div className="mb-10 rounded-md border border-crimson/30 bg-crimson/5 p-4">
        <p className="text-[#1A1A1A] font-semibold text-sm uppercase tracking-wide mb-2">
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-[#737373] [&_h2]:text-[#1A1A1A] [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mt-10 [&_h2]:mb-4 [&_strong]:text-[#1A1A1A] [&_h3]:text-[#1A1A1A] [&_h3]:text-base [&_h3]:font-semibold [&_h3]:mt-6 [&_h3]:mb-2">
        ...
        <p>
          ...
          <a href="mailto:support@aioperatorcollective.com" className="text-crimson hover:underline">
        ...
        <p className="text-[#1A1A1A] font-semibold uppercase tracking-wide text-xs leading-relaxed">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Month-to-month memberships may be cancelled with 30 days written notice to <a href="mailto:support@aioperatorcollective.com" className="text-crimson hover:underline">support@aioperatorcollective.com</a>. Cancellation takes effect at the end of the then-current billing period. No partial-month refunds.</li>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Technical and usage data (see our <Link href="/privacy" className="text-crimson hover:underline">Privacy Policy</Link>)</li>
        </ul>
        ...
        <p>
          ...
          <a href="mailto:privacy@modern-amenities.com" className="text-crimson hover:underline">
        ...
        <p className="text-[#1A1A1A] font-semibold">Please read this Section carefully. It affects your legal rights.</p>
