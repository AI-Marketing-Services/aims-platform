      ...
      <section className="py-16 px-4 bg-[#FAFAFA]">
        <div className="max-w-3xl mx-auto">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-1">Revenue Operations Suite</h2>
            <p className="text-sm text-gray-500 mb-4">Turn your dealership sales process into a repeatable, data-driven machine with AI-powered pipeline management, team enablement, and finance automation.</p>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-gray-900">from $397/mo</span>
