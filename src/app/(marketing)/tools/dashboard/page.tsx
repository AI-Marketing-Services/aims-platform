      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        {submissions.length > 0 ? (
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      {sub.type === "AI_READINESS_QUIZ" && (
                        <Link
                          ...
                          className="inline-flex items-center gap-1.5 text-xs font-medium text-[#C4972A] hover:underline"
                        >
                          View results
          ...
          <div className="bg-card border border-dashed border-border rounded-2xl p-10 text-center mb-10">
            ...
            <Link
              href="/tools/ai-readiness-quiz"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#C4972A] text-white text-sm font-semibold rounded-lg hover:bg-[#A17D22] transition-colors"
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {remainingTools.map((tool) => (
                ...
                >
                  ...
                  <span className="inline-flex items-center gap-1 text-xs font-medium text-[#C4972A] group-hover:underline">
                    Start free
        ...
        {/* Upgrade CTA */}
        {submissions.length > 0 && (
          <div className="mt-10 bg-[#C4972A] rounded-2xl p-8 text-center text-white">
            ...
            <Link
              href="/marketplace"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#C4972A] text-white text-sm font-semibold rounded-lg hover:bg-[#A17D22] transition-colors"
            >
              Browse Services
              <ArrowRight className="w-4 h-4" />
            </Link>
