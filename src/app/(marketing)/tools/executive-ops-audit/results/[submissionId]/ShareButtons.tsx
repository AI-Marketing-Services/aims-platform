...
export function ShareButtons({ shareUrl, costOfInefficiency }: Props) {
  ...
  const shareText = `I just ran an executive operations audit — $${costOfInefficiency.toLocaleString()}/yr in inefficiency identified. Get yours: ${shareUrl}`
