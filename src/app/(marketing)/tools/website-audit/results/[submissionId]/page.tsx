      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-500 text-sm">
            Audit for <span className="font-medium text-gray-700">{domain}</span>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center shadow-sm mb-6">
          ...
          <div className="text-gray-400 text-sm mb-4">Overall Marketing Health Score</div>
          <div className="max-w-xs mx-auto mb-4">
            <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
              <div
                className={cn("h-3 rounded-full", overallScore >= 70 ? "bg-green-500" : overallScore >= 50 ? "bg-yellow-500" : "bg-red-500")}
        ...
        {analysis?.strengths && analysis.strengths.length > 0 && (
          <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-6 shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-4">What&apos;s Working</h3>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-amber-800 text-sm">{analysis.topOpportunity}</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-6 shadow-sm">
          ...
          <p className="text-sm text-gray-500 mb-4">Show your team or share with a colleague.</p>
        ...
        <p className="text-center text-sm text-gray-400">
          ...
          <Link href="/tools/website-audit" className="text-[#DC2626] hover:underline font-medium">
            Run a new audit
          </Link>
        </p>
      </div>
