  ...
  return (
    <main className="bg-[#FAFAFA]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat) => (
            <div key={stat.label} className="bg-white border border-gray-200 rounded-2xl p-6">
              <stat.icon className="w-5 h-5 text-[#DC2626] mb-3 mx-auto" />
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Old Agency vs. AIMS</h2>
            <p className="text-gray-600">Every line item matters when it comes to your pipeline.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {/* Old way */}
            <div className="bg-white border border-gray-200 rounded-2xl p-8">
              <h3 className="font-semibold text-gray-500 mb-6 text-sm uppercase tracking-wider">The Old Agency Model</h3>
            ...
            <div className="bg-white border-2 border-[#DC2626] rounded-2xl p-8">
              <h3 className="font-semibold text-[#DC2626] mb-6 text-sm uppercase tracking-wider">The AIMS Way</h3>
              <div className="space-y-4">
                {aimsWay.map((item) => (
                  <div key={item} className="flex items-start gap-3">
      ...
      <section className="py-16 px-4 bg-white border-y border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">The AIMS Difference</h2>
            <p className="text-gray-600">Four principles that make every engagement different.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            {pillars.map((p) => (
              <div key={p.title} className="bg-[#FAFAFA] border border-gray-200 rounded-2xl p-8">
      ...
      <section className="py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to see AIMS in action?</h2>
          <p className="text-gray-600 mb-8">Book a 30-minute strategy call. We&apos;ll audit your pipeline and show you exactly what AIMS would build for your business.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              ...
              className="px-8 py-4 border border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-gray-400 transition-colors"
            >
