      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-card border border-border rounded-lg text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
          />
        </div>
              ...
              <div className="p-5 flex-1">
                ...
                <div className="flex items-start justify-between mb-3 gap-2">
                  <div className="flex flex-col gap-1">
                    {isRecommended && (
                      <span className="self-start bg-primary/10 text-primary border border-primary/30 text-[10px] font-bold uppercase tracking-wider rounded-full px-2 py-0.5">
                        Recommended for you
                      </span>
                    )}
                    {!isSubscribed && (
              ...
              <div className="px-5 pb-5">
                ...
                {isSubscribed ? (
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2.5 bg-primary text-primary-foreground text-xs font-semibold rounded-lg hover:bg-primary/90 transition-colors"
                  >
                    Request Quote
                    <ArrowRight className="h-3.5 w-3.5" />
                  </button>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2.5 bg-primary text-primary-foreground text-xs font-semibold rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
