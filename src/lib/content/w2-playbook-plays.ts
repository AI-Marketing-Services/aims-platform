...
export const W2_PLAYS: Play[] = [
  ...
  },
  {
    ...
    toolsToUse: ["LinkedIn", "Loom for the audit walkthrough", "Google Docs for the audit deliverable", "Notion for tracking"],
  ...
  },
  {
    ...
    steps: [
      "Pick the most specific possible vertical you can credibly speak to from your W-2.",
  ...
  },
  {
    ...
    toolsToUse: ["Claude Projects", "Cursor", "Notion AI", "Otter or Fireflies for meeting notes"],
  ...
  },
  {
    ...
    toolsToUse: ["Bland.ai", "Vapi", "Retell AI", "Twilio (for routing)", "Stripe for billing"],
    realWorldExample: "A former corporate IT manager spun up 12 AI voice agents for local home service businesses in 6 months. $2,400/mo recurring at month 6. Quit his W-2 at month 8.",
  ...
  },
  {
    ...
    toolsToUse: ["Beehiiv or Substack", "Claude for first drafts", "Loom for visuals", "Senja for collecting testimonials"],
  ...
  },
  {
    ...
    steps: [
      "Build a Claude project with one executive's voice loaded as the system prompt (paste 30 of their old posts).",
  ...
  },
  {
    ...
    toolsToUse: ["Claude (Sonnet or Opus)", "Firecrawl", "Cursor", "Notion for delivery", "Canva for visual polish"],
